                    ...
                    <CardHeader className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                        <div>
                            ...
                            <CardDescription className="text-sm text-muted-foreground">
                                Здесь вы можете узнать, кто отправлял вам
                                запросы на повышение уровня компетенции.
                            </CardDescription>
                        </div>
                    </CardHeader>
                        ...
                        {isFetching ? (
                            <div className="space-y-3">
                                {[0, 1, 2].map((i) => (
                                    <div
                                        key={i}
                                        className="flex items-center justify-between gap-4 p-4 rounded-lg bg-muted/30 animate-pulse">
                                ...
                                {requests &&
                                    requests.map((rq) => {
                                        ...
                                        const initials = owner
                                            ? `${owner.employee_name?.[0] ?? ''}${owner.employee_surname?.[0] ?? ''}`
                                            : ''
                                        return (
                                            <div
                                                key={rq.request_id}
