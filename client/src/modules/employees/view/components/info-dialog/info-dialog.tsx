...
export const InfoDialog = ({
    ...
    } = useGetTeams(data?.company.company_id || 0)
        ...
        <DialogContent>
                ...
                {isLoading || teamsLoading || isFetching || teamsFetching ? (
                    ...
                    <>
                        <DialogTitle className="capitalize">
                            Сотрудник {data?.employee_surname}{' '}
                            {data?.employee_name}
                        </DialogTitle>
                        <DialogDescription>
            ...
            {isLoading || teamsLoading || isFetching || teamsFetching ? (
                ...
                <DialogFooter>
                    ...
                    <Button type="submit" form="add-employee-to-team-form">
                        Сохранить
                    </Button>
                </DialogFooter>
            )}
