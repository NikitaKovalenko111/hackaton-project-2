...
export function SkillOrdersTable({data, isFetching, handleChangeSelectedSkills}: SkillsTableProps) {
    ...
    const columns: ColumnDef<SkillOrderGet>[] = [
        {
            ...
            cell: ({ row }) => (
            <div className="text-center capitalize">{row.original.skill_shape.skill_name}</div>
            ),
        },
        {
        ...
        <div className="w-full">
            <Dialog key={"create-dialog"} open={openCreateDialog} onOpenChange={handleCloseCreateDialog}>
                <div className="flex justify-between items-center py-4 sm:flex-wrap gap-2.5">
                    ...
                    className="max-w-sm"
                    /> */}
                        <MultipleSelectWithPlaceholderDemo categories={categories || []} handleChangeSkills={handleChangeSelectedSkills} />
