...
export const SkillUsersTable = ({
    ...
    const handleAddUserToSkill = (user: EmployeeTable) => {
        ...
        setRemovedUsers((prev) =>
            prev.filter((empl) => empl.employee_id != user.employee_id)
        )
    }
    ...
    const columnsAdded: ColumnDef<EmployeeTable>[] = [
        {
            ...
            header: () => {
                return <p className="text-center">Имя Фамилия</p>
            },
            cell: ({ row }) => (
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <div className="text-center">
                    {roleBadge(row.original.role.role_name)}
                </div>
            ),
        },
        {
                        ...
                        <Minus
                            ...
                            onClick={() => {
                                handleRemoveUserToSkill({
                                    ...
                                    employee_surname:
                                        row.original.employee_surname,
                                    role: row.original.role,
                                    skills: row.original.skills,
                                })
                                removeSkill(
                                    row.original.skills.find(
                                        (skillShape) =>
                                            skillShape.skill_shape
                                                .skill_shape_id == id
                                    )?.skill_connection_id!
                                )
                            }}
