...
const MultipleSelectWithPlaceholderDemo = ({handleChangeSkills, categories}: {handleChangeSkills: (names: string[]) => void, categories: Option[]}) => {
    ...
    return (
        <div className='w-full max-w-xs space-y-2'>
            ...
            <MultipleSelector
                ...
                onChange={(e) => handleChangeSkills(e.map((item) => item.value))}
