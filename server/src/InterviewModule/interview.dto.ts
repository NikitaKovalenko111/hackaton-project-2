...
export class addInterviewBodyDto {
  @ApiProperty({
    example: 5,
    description: 'ID сотрудника, с которым проводится интервью',
  })
  ...
  @ApiProperty({
    example: 'Обсуждение итогов испытательного срока',
    description: 'Описание интервью',
  })
...
export class finishInterviewBodyDto {
  ...
  interview_id: number
  @ApiProperty({
    example: 'Отличное выступление, кандидат принят.',
    description: 'Комментарий по итогам интервью',
  })
  interview_comment: string
  @ApiProperty({
    example: 45,
    description: 'Длительность интервью (в минутах)',
  })
